            ...
            <div class="container-fluid" style="height: 100%;">
                <div class="row" style="height: 100%;">
                    ...
                    <div style="width: 90%;background: rgba(146,146,146,0.79);height: 100%;margin-left: 4%;border-color: rgb(33, 37, 41);border-top-color: rgb(33,37,41);">
                            ...
                            <div class="d-xl-flex align-items-center justify-content-xl-start align-items-xl-center" style="border-style: none;height:13.74vw;"><input class="btn btn-primary" type="submit" style="background: linear-gradient(-76deg, rgb(249,54,124) 0%, rgb(247,0,88) 100%);border-radius: 10px;border-style: none;box-shadow: 0px 0px 4px rgb(85,0,0);margin: 0px;margin-left: 34vw;width: 60px;height: 40px;margin-top: 5vw;padding: 0px;">
