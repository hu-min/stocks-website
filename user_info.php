                ...
                <div class="row" style="height: 100%;">
                    <div class="col-md-12" style="height: 100%;color: rgb(249,54,124);background: url(&quot;assets/img/desk.jpg&quot;) no-repeat, #151515;background-size: cover, auto;border-left-style: solid;border-left-color: rgb(190,12,76);">
                        <div style="width: 90%;background: rgba(146,146,146,0.79);height: 100%;margin-left: 4%;border-color: rgb(33, 37, 41);border-top-color: rgb(33,37, 41);">
                            ...
                            <a href="user_info_edit.php"><button class="btn btn-primary" type="button" style="background: linear-gradient(-76deg, rgb(249,54,124) 0%, rgb(247,0,88) 100%);border-radius: 10px;border-style: none;box-shadow: 0px 0px 4px rgb(85,0,0);margin-left: 34vw;width: 60px;height: 40px;padding: 0px;">Edit</button></a>
                            <form action="req_access.php" method="post"><input class="btn btn-primary" type="submit" name="submit" value="Request Admin Access" style="background: linear-gradient(-76deg, rgb(249,54,124) 0%, rgb(247,0,88) 100%);border-radius: 10px;border-style: none;box-shadow: 0px 0px 4px rgb(85,0,0);margin-left: 30vw;margin-top:2vw;width: auto;height: 40px;padding: 4px;">
                            <a href="log_out.php"><button class="btn btn-primary" type="button" style="background: linear-gradient(-76deg, rgb(249,54,124) 0%, rgb(247,0,88) 100%);border-radius: 10px;border-style: none;box-shadow: 0px 0px 4px rgb(85,0,0);width: auto;height: 40px;margin-top:2vw;">Log Out</button></a>
                        </div></form>
                        </div>
                    </div>
                </div>
